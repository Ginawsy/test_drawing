"use strict"
import * as compile from './compiler.js';
import {compileCwise} from "./compiler.js";
...
export function makeOp(user_args) {
  var args = []
...
export function divseq() {
    var op = assign_ops['div']
    makeOp({
        args: ["array","scalar"],
        body: {args:["a","s"],
            body:"a"+op+"=s"},
